...
import tolol from '../assets/img/tolol.jpg'
import tololl from '../assets/sound/tolol.mp3'
  ...
  return (
    <div className='flex flex-col gap-2 py-2 justify-center items-center w-32 aspect-square shadow-md'>
      <motion.button 
        ...
        onClick={handleClick}
      >
        <img src={tolol} alt='Tolol' className='object-cover w-full h-full'/>
      </motion.button>
      <Switch
        checked={checked}
