...
import waduh from '../assets/img/waduh.jpg'
import waduhh from '../assets/sound/waduh.mp3'
  ...
  return (
    <div className='flex flex-col gap-2 py-2 justify-center items-center w-32 aspect-square shadow-md'>
      <motion.button 
        ...
        onClick={handleClick}
      >
        <img src={waduh} alt='wutdehel' className='object-cover w-full h-full'/>
      </motion.button>
      <Switch
        checked={checked}
