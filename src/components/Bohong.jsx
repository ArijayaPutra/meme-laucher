...
import bohong from '../assets/img/bohong.jpg'
import bohongg from '../assets/sound/bohong.mp3'
  ...
  return (
    <div className='flex flex-col gap-2 py-2 justify-center items-center w-32 aspect-square shadow-md'>
      <motion.button 
        ...
        onClick={handleClick}
      >
        <img src={bohong} alt='Bohong' className='object-cover w-full h-full'/>
      </motion.button>
      <Switch
        checked={checked}
