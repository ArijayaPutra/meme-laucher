...
import bonk from '../assets/img/bonk.jpg'
import bonkk from '../assets/sound/bonk.mp3'
  ...
  return (
    <div className='flex flex-col gap-2 py-2 justify-center items-center w-32 aspect-square shadow-md   '>
      <motion.button 
        ...
        onClick={handleClick}
      >
        <img src={bonk} alt='Bonk' className='object-cover w-full h-full'/>
      </motion.button>
      <Switch
        checked={checked}
