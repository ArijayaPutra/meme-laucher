...
import opet from '../assets/img/opet.jpg'
import opett from '../assets/sound/opet.mp3'
  ...
  return (
    <div className='flex flex-col gap-2 py-2 justify-center items-center w-32 aspect-square shadow-md   '>
      <motion.button 
        ...
        onClick={handleClick}
      >
        <img src={opet} alt='Opet' className='object-cover w-full h-full'/>
      </motion.button>
      <Switch
        checked={checked}
