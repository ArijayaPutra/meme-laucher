...
import kaget from '../assets/img/kaget.jpg'
import kagett from '../assets/sound/kaget.mp3'
  ...
  return (
    <div className='flex flex-col gap-2 py-2 justify-center items-center w-32 aspect-square shadow-md'>
      <motion.button 
        ...
        onClick={handleClick}
      >
        <img src={kaget} alt='Kaget' className='object-cover w-full h-full'/>
      </motion.button>
      <Switch
        checked={checked}
